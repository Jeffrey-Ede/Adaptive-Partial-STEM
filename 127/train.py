...
tf.flags.DEFINE_float("supervision_start", 1., "Starting value for supevision.")
tf.flags.DEFINE_float("supervision_end", 0., "Starting value for supevision.")
...
tf.flags.DEFINE_integer("start_iter", 644_520, "Starting iteration")
