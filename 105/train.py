...
tf.flags.DEFINE_integer("projection_size", 32, "Size of projection layer. Zero for no projection.")
...
tf.flags.DEFINE_integer("start_iter", 454_196, "Starting iteration")
