...
tf.flags.DEFINE_float("ou_theta", 0.2, "Drift back to mean.")
tf.flags.DEFINE_float("ou_sigma", 0.4, "Size of random process.")
...
tf.flags.DEFINE_bool("is_true_action", True, "True to replace replay actor actions with true actions.")
