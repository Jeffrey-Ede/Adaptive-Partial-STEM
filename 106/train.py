...
tf.flags.DEFINE_integer("projection_size", 64, "Size of projection layer. Zero for no projection.")
...
tf.flags.DEFINE_integer("start_iter", 198_639, "Starting iteration")
